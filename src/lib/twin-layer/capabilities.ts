...
export const CAPABILITIES: Capability[] = [
  ...
  { id: "nec_load_calculation", router: "nec_load_calculation", endpointGroup: "/nec-load-calc", supports: "Service-size readiness on Home",  status: "backend_only", uiStatus: "future_wired",      uiLocations: ["/twin · Stub: Service capacity check"], note: "No card today; referenced only in /explore Learn." },
  ...
  // ─── Planner ───────────────────────────────────────────────────────────
  { id: "designs",                router: "designs",                endpointGroup: "/designs",                 supports: "Scenario builder rows",          status: "future_wired", uiStatus: "future_wired",      uiLocations: ["/scenario · Stub: Design drafts"], note: "Scenarios render directly today — no separate design entity in the UI." },
  ...
  { id: "estimate_readiness",     router: "estimate_readiness",     endpointGroup: "/estimate-readiness",      supports: "Readiness gates on each scenario", status: "future_wired", uiStatus: "future_wired",      uiLocations: ["/scenario · Stub: Estimate readiness gate"], note: "Today only confidence dots are shown; explicit readiness gate is absent." },
  ...
  { id: "post_install",           router: "post_install",           endpointGroup: "/post-install",            supports: "Future: after-install checklist", status: "backend_only", uiStatus: "future_wired",      uiLocations: ["/progress · Stub: After install"] },
  ...
  { id: "privacy",            router: "privacy",            endpointGroup: "/internal/privacy",          supports: "Share scope on CRM handoff",   status: "backend_only", uiStatus: "future_wired",      uiLocations: ["/internal · Stub: Share scope & redaction"] },
];
